...
void GLES2Lesson::resetTransformMatrices() {
	...
	pyramidTransformMatrix = glm::rotate(
			glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, 0.0f, -6.0f)),
			pyramidRotationAngle * rads, glm::vec3(0.0f, 1.0f, 0.0f));
	cubeTransformMatrix = glm::rotate(glm::translate(glm::mat4(1.0f), glm::vec3(1.5f, 0.0f, -6.0f)),
									  cubeRotationAngle * rads, glm::vec3(1.0f, 0.0f, 0.0f));
}
