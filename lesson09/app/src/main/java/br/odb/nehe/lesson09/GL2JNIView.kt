...
import br.odb.nehe.lesson09.GL2JNILib.init
import br.odb.nehe.lesson09.GL2JNILib.step
...
internal class GL2JNIView(context: Context?) : GLSurfaceView(context) {
	private fun init(translucent: Boolean, depth: Int) {
		if (translucent) {
			this.holder.setFormat(PixelFormat.TRANSLUCENT)
		}
		setEGLContextFactory(ContextFactory())
		setEGLConfigChooser(ConfigChooser(5, 6, 5, 0, depth))
	...
	companion object {
		private const val TAG = "Lesson09 NeHe View"
