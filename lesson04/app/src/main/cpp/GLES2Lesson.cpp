...
void GLES2Lesson::resetTransformMatrices() {
	...
	triangleTransformMatrix = glm::rotate(
			glm::translate(glm::mat4(1.0f), glm::vec3(-1.5f, 0.0f, -6.0f)),
			triangleRotationAngle * rads, glm::vec3(0.0f, 1.0f, 0.0f));
	squareTransformMatrix = glm::rotate(
			glm::translate(glm::mat4(1.0f), glm::vec3(1.5f, 0.0f, -6.0f)),
			squareRotationAngle * rads, glm::vec3(1.0f, 0.0f, 0.0f));
}
