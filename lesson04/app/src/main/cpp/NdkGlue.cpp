...
Java_br_odb_nehe_lesson04_GL2JNILib_onCreate(JNIEnv *env, jobject clazz, jobject assetManager) {
	loadShaders(env, assetManager);
}

extern "C"
JNIEXPORT void JNICALL
Java_br_odb_nehe_lesson04_GL2JNILib_init(JNIEnv *env, jobject clazz, jint width, jint height) {
	setupGraphics(width, height);
}

extern "C"
JNIEXPORT void JNICALL
Java_br_odb_nehe_lesson04_GL2JNILib_step(JNIEnv *env, jobject clazz) {
	renderFrame();
}

extern "C"
JNIEXPORT void JNICALL
Java_br_odb_nehe_lesson04_GL2JNILib_tick(JNIEnv *env, jobject clazz) {
	tick();
}

extern "C"
JNIEXPORT void JNICALL
Java_br_odb_nehe_lesson04_GL2JNILib_onDestroy(JNIEnv *env, jobject clazz) {
	shutdown();
}
