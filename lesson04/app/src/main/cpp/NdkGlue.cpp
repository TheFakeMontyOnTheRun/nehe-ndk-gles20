...
extern "C" {
JNIEXPORT void JNICALL Java_br_odb_nehe_lesson04_GL2JNILib_onCreate(JNIEnv *env, jclass type,
                                                                    jobject assetManager);
JNIEXPORT void JNICALL Java_br_odb_nehe_lesson04_GL2JNILib_onDestroy(JNIEnv *env, jclass type);

JNIEXPORT void JNICALL Java_br_odb_nehe_lesson04_GL2JNILib_init(JNIEnv *env, jclass type,
                                                                jint width, jint height);
JNIEXPORT void JNICALL Java_br_odb_nehe_lesson04_GL2JNILib_step(JNIEnv *env, jclass type);

JNIEXPORT void JNICALL Java_br_odb_nehe_lesson04_GL2JNILib_tick(JNIEnv *env, jclass type);
};
